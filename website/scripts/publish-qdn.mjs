...
const TITLE = 'Qortium Casino — The SMPL Vault Is Open';
const DESCRIPTION = 'A deliberately excessive Qortium Casino campaign, now with an actually open SMPL faucet.';
